...
class PreprocessingConfig(BaseModel):
    ...
    categorical_columns: list[str] = ["type_of_meal_plan", "required_car_parking_space", "room_type_reserved", "market_segment_type", "repeated_guest", "booking_status"]
    numerical_columns: list[str] =  ['no_of_adults', 'no_of_children',
...
def get_config():
    ...
    model_params = Model(light_params=LightGPMParams(), random_search=RandomSearchParams())
