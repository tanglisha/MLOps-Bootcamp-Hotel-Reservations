...
RUN if [ -z ${GOOGLE_APPLICATION_CREDENTIALS} ] ; then GOOGLE_APPLICATION_CREDENTIALS="${GOOGLE_APPLICATION_CREDENTIALS}"; fi poetry run python pipeline/training_pipeline.py
